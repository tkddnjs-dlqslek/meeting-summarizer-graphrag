...
| **총 코드량** | 약 1,700줄 (리팩터링 + 실험 스크립트 포함) |
| **주요 기술** | FastAPI, Claude Sonnet 4.6 (tool_use), Neo4j, faster-whisper, HuggingFace datasets, jiwer |
| **검증 상태** | 로컬 샘플 + AMI ES2002 4회차 텍스트 경로 + ES2002a 오디오 경로 E2E 통과 |
| **핵심 성과** | 회차 간 Speaker/Topic/Entity 공유 병합 + GraphRAG 교차 회차 질의 작동 + STT→그래프 품질 전파 실증 |
